...
{
	return CallVFunction<bool(__thiscall*)(C_BaseEntity*)>(this, 153 + 4)(this);
}
...
{
	return CallVFunction<bool(__thiscall*)(C_BaseEntity*)>(this, 161 + 4)(this);
}
...
{
	return CallVFunction<CCSWeaponInfo*(__thiscall*)(void*)>(this, 448 + 12)(this);
}
...
{
	static auto inReload = *(uint32_t*)(Utils::PatternScan(GetModuleHandleA(("client.dll")), "C6 87 ? ? ? ? ? 8B 06 8B CE FF 90") + 2);
	return *(bool*)((uintptr_t)this + inReload);
}

float C_BaseCombatWeapon::GetInaccuracy()
{
	return CallVFunction<float(__thiscall*)(void*)>(this, 471 + 11)(this);
}

float C_BaseCombatWeapon::GetSpread()
{
	return CallVFunction<float(__thiscall*)(void*)>(this, 440 + 12)(this);
}

void C_BaseCombatWeapon::UpdateAccuracyPenalty()
{
	CallVFunction<void(__thiscall*)(void*)>(this, 472 + 11)(this);
}

CUtlVector<IRefCounted*>& C_BaseCombatWeapon::m_CustomMaterials()
{	static auto inReload = *(uint32_t*)(Utils::PatternScan(GetModuleHandleA(("client.dll")), "83 BE ? ? ? ? ? 7F 67") + 2) - 12;
	return *(CUtlVector<IRefCounted*>*)((uintptr_t)this + inReload);
}

bool* C_BaseCombatWeapon::m_bCustomMaterialInitialized()
{
	static auto currentCommand = *(uint32_t*)(Utils::PatternScan(GetModuleHandleA(("client.dll")), "C6 86 ? ? ? ? ? FF 50 04") + 2);
	return (bool*)((uintptr_t)this + currentCommand);
}

CUserCmd*& C_BasePlayer::m_pCurrentCommand()
{
	static auto currentCommand = *(uint32_t*)(Utils::PatternScan(GetModuleHandleA(("client.dll")), "89 BE ? ? ? ? E8 ? ? ? ? 85 FF") + 2);
...
int C_BasePlayer::GetSequenceActivity(int sequence)
{
	...
	static auto get_sequence_activity = reinterpret_cast<int(__fastcall*)(void*, studiohdr_t*, int)>(Utils::PatternScan(GetModuleHandleA("client.dll"), "55 8B EC 83 7D 08 FF 56 8B F1 74 3D"));
...
{
	static int basePlayerAnimStateOffset = 0x3914;
...
{
	return *(CCSPlayerAnimState**)((DWORD)this + 0x3914);
}
...
bool C_BasePlayer::HasC4()
{
	static auto fnHasC4
		= reinterpret_cast<bool(__thiscall*)(void*)>(
			Utils::PatternScan(GetModuleHandleA(("client.dll")), ("56 8B F1 85 F6 74 31"))
			);
...
{
	static auto inReload = *(uint32_t*)(Utils::PatternScan(GetModuleHandleA(("client.dll")), ("81 C7 ? ? ? ? 8B 4F 0C 8B 57 04 89 4C 24 0C")) + 2);
	return *(CUtlVector<IRefCounted*>*)((uintptr_t)this + inReload);
}
