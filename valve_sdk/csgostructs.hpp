...
public:
	...
	void SetVecAbsOrigin(const Vector value)
	{
		...
		if (!SetAbsOrigin)
			SetAbsOrigin = reinterpret_cast<oGetServrAngles>(Utils::PatternScan(GetModuleHandleA(("client.dll")), ("55 8B EC 83 E4 F8 51 53 56 57 8B F1")));
	...
	void SetAbsAngles(const QAngle value)
	{
		...
		if (!SetAbsAngles)
			SetAbsAngles = reinterpret_cast<oGetServrAngles>(Utils::PatternScan(GetModuleHandleA(("client.dll")), ("55 8B EC 83 E4 F8 83 EC 64 53 56 57 8B F1 E8")));
